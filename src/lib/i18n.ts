...
const dictionaries: Record<Lang, Record<string, string>> = {
  de: {
    ...
    "profile.delete.body": "Entfernt alle Reisen und Bucketlist-Einträge und löscht dein Konto sofort.",
    ...
    "profile.delete.hint": "Die Löschung ist endgültig. Du benötigst ein neues Profil, um wieder einzusteigen.",
    "profile.delete.confirmTitle": "Bist du sicher?",
    "profile.delete.confirmHint": "Dieser Schritt löscht dein Konto und alle Daten sofort.",
    "profile.delete.loading": "Lösche...",
    "profile.delete.done": "Dein Konto wurde gelöscht. Du kannst ein neues Profil erstellen."
  },
  en: {
    "nav.reisen": "Trips",
    ...
    "profile.delete.body": "Removes all trips and bucket list entries and deletes your account immediately.",
    ...
    "profile.delete.hint": "Deletion is permanent. You'll need a new profile to sign in again.",
    "profile.delete.confirmTitle": "Are you sure?",
    "profile.delete.confirmHint": "This step deletes your account and all data immediately.",
    "profile.delete.loading": "Deleting...",
    "profile.delete.done": "Your account was deleted. You can create a new profile."
  },
  fr: {
    "nav.reisen": "Voyages",
    "nav.bucketlist": "Bucket List",
    ...
    "profile.delete.body": "Supprime toutes tes données (voyages, bucket list) et efface ton compte immédiatement.",
    ...
    "profile.delete.hint": "La suppression est définitive. Il faudra créer un nouveau profil pour revenir.",
    "profile.delete.confirmTitle": "Tu es sûr ?",
    "profile.delete.confirmHint": "Cette étape supprime ton compte et toutes les données immédiatement.",
    "profile.delete.loading": "Suppression...",
    "profile.delete.done": "Ton compte a été supprimé. Tu peux créer un nouveau profil."
  },
  it: {
    "nav.reisen": "Viaggi",
    "nav.bucketlist": "Bucket List",
    ...
    "profile.delete.body": "Rimuove tutti i dati (viaggi e bucket list) e cancella subito il tuo account.",
